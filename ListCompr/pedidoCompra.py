...
for cod, qtd_estoque in estoque:
    if (qtd_estoque < 1000) and (qtd_estoque >= 200):
      qtd_estoque += 500
      print(f'{cod}, aumentou 500 {qtd_estoque}')
    elif (qtd_estoque < 200):
      qtd_estoque += 1000
      print(f'{cod}, aumentou 1000 {qtd_estoque}')
print('------------------')

estoque2 = [1000 if qtd <200 else 500 for cod, qtd in estoque]
print(estoque2)