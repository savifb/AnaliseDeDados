def compara_produtos(*listas):
    lista_produtos = []
    for item in listas:
        for produto, estoque in item: 
...
print(len(compara_produtos(estoque_fim_jan)))
print(len(compara_produtos(estoque_fim_fev)))
print(len(compara_produtos(estoque_fim_mar)))
print(len(compara_produtos(estoque_fim_abr)))
print(compara_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr))